          ...
          <div className="mb-6 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-slate-600">
                The next Swift Tees weekend is confirmed and ready to go.
              </p>
          ...
          <div className="grid overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-slate-200 md:grid-cols-[1.1fr_.9fr]">
            ...
            <div className="p-7 md:p-10">
              ...
              <p className="mt-5 max-w-xl leading-7 text-slate-600">
                ...
                2026. Two rounds at Worsley Park with an overnight
                stay at Delta Hotels by Marriott Worsley Park
                Country Club.
              </p>
              ...
              <a
                href="/events/worsley-park-september-2026"
                className="mt-7 flex w-full items-center justify-between rounded-2xl bg-green-950 px-5 py-4 text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-green-900"
              >
                <div>
